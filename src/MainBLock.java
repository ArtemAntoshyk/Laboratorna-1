public class MainBLock {
    ...
    public MainBLock(int nCPU, int nFlow, int nQueue, int nProcesses) {
     ...
     */
    public MainBLock(int nProcesses) {
        this(NUMBER_OF_CPU, NUMBER_OF_FLOWS, NUMBER_OF_QUEUE, nProcesses);
    }


    private static boolean isAnyFlowAilive(MainBLock ss) {
    ...
    private static boolean isAnyCPUAilive(MainBLock ss) {
    ...
    public static void main(String[] args) {
        MainBLock ss = new MainBLock(NUMBER_OF_PROCESS);  //  by default generate 25 process by each flow
